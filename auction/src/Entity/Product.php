 ...
 * Product
 *
 * @ORM\Table(name="product", indexes={@ORM\Index(name="fk_product_price1_idx", columns={"price_id"}), @ORM\Index(name="fk_product_author_name1_idx", columns={"author_id"}), @ORM\Index(name="fk_product_product_status1_idx", columns={"product_status_id"}), @ORM\Index(name="product_product_about_id_fk", columns={"product_about_id"}), @ORM\Index(name="fk_product_user1_idx", columns={"owner_id"}), @ORM\Index(name="fk_product_product_category1_idx", columns={"product_category_id"})})
 * @ORM\Entity
 */
class Product
{
