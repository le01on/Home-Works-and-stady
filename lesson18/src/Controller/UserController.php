...
use App\Model\User;
use App\Model\WriteLogAndNotFoundExceptionToFile;
    ...
    public function formUpdate(ServerRequestInterface $request)
    {
        ...
        if (array_key_exists('id', $query)) {
            try {
                ...
                $logException = new WriteLogAndNotFoundExceptionToFile();
                $logException->writeUserLog($request);
                $logException->writeNotFoundException($e);
